...
import com.kqh.computerstore.entity.Favorites;
import com.kqh.computerstore.entity.Product;
import com.kqh.computerstore.mapper.FavoritesMapper;
import com.kqh.computerstore.service.IFavoritesService;
...
public class IFavoritesServiceImpl implements IFavoritesService {
     ...
     * @param uid 用户uid
     * @param status 查询商品状态
     * @return java.util.List<com.kqh.computerstore.entity.Favorites>
     **/
    @Override
